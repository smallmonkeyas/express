/*
 * @Author: your name
 * @Date: 2021-08-11 13:06:26
 * @LastEditTime: 2021-08-11 13:06:28
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \SolidPollutionItem\compenent\flowchart\flowReuseCom_copy1.js
 */
  ...
  async function renderFreshData(dataTooltipPArr) {
    ...
    if(!lastTime){
      ...
      lastTimeStr = moment(lastTime).utc().format("YYYY-MM-DD HH:mm:ss");
    }
    return {

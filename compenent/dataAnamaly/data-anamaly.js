...
/*
 * @Author: your name
 * @Date: 2021-09-15 23:36:55
 * @LastEditTime: 2021-09-16 17:34:47
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \express\compenent\dataAnamaly\data-anamaly.js
 */
...
async function getHisDataByhttpInterface(selectedRows, epcode) {
    const hisEndTime = moment(selectedRows.starttime).add(1, "hours").format("YYYY-MM-DD HH:mm:ss")
...
class AnamalyDetectChartTab extends Component {
    ...
    rowCheckSelect = (selectedRowKeys, selectedRows) => {
        ...
        this.setState({ rowSelectedKey: selectedRowKeys[0] })
        chart.update({
            chart: {
                type: "line"
            }
    ...
    render() {
        ...
        let rowSelection = {
            ...
            getCheckboxProps: (record) => {
                // this.rowCheckSelect(this.state.rowSelectedKey, selectedRows)

/*
 * @Author: your name
 * @Date: 2021-07-10 19:11:04
 * @LastEditTime: 2021-09-16 13:12:41
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \supos-app-project-cli-master\supos-app-project-cli-master\frontend\components\src\controls\RuleCom\RuleDepot_copy.js
 */
  ...
  save(form, record) {
    ...
    form.validateFields((error, row) => {
      ...
      if (index > -1) {
        ...
        row.content = oldNameStr.replace(/[0-9]+/g,(ii)=>{
        ...
        if (count === parseInt(key, 10)) {
          ...
          newData[record.key].creatTime = moment().format(
            'YYYY-MM-DD HH:mm:ss'
          );
          callService(objName, serviceName, params, res => {
            if (res.code === '200') {
        ...
        <div className="mainbox">
          ...
          <div className="middlebox">
            ...
            <Modal title="添加规则"
              ...
              onOk={(e, record) => { this.handleOK(e, record) }}

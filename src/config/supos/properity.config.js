...
exports.properityExcludeAlarmInfo = exports.properityInfo = void 0;
const properityInfo = function (objectName, 
// objectDisplayName: string,
// objectDscription: string,
propName, propDisplayName, propDescription, primitiveType, 
// propValue: number,
alarmPropName, 
...
exports.properityInfo = properityInfo;
const properityExcludeAlarmInfo = function (objectName, propName, propDisplayName, propDescription, primitiveType) {
    return {
        "name": `${propName}`,
        "primitiveType": `${primitiveType}`,
        "showName": `${propDisplayName}`,
...
exports.properityExcludeAlarmInfo = properityExcludeAlarmInfo;

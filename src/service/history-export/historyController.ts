 ...
 * @LastEditTime : 2021-12-24 20:59:31
...
const main = async function () {
    ...
    if (Array.isArray(collectors)) {
        collectors.forEach((collector: IFactoryStruct) => {
            ...
            if (epcode == "321000000035" && type == "GK") {
                objname = "GK_YZ_GKWNFD" // 扬州污泥
            }
            if (epcode == "320300000089" && type == "GK") {
                objname = "GK_9132031279905990XA" // 铜山华润电力有限公司
            }
            let hj212mn = mn
    ...
    let factorsInfo = await factorHandler.select({ epcode: "320300000089" }, null)
